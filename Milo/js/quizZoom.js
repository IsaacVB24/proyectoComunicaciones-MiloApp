...
function acabarTodoElQuiz(){
    if(quiz1 == 1 & quiz2 == 1){
        ...
        document.getElementById("preguntaCompPantalla").innerHTML = "¡Felicidades! Completaste todos los Quizes de esta sección.<br><br><table style='font-weight: initial; font-size: large;'><tr><td><button onclick='recargar();' href='../html/quizZoom.html'>Repetir Quiz</button></td><td><button style='margin-left:1%;'><a sytle = '  border-radius: 50%;'href='../html/index.html'>Regresar al menú principal</a></button></td></tr></table>";
    }
}
function recargar(){
    location.reload();
